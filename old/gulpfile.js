...
gulp.task("nools", shell.task("webpack --config ./webpack.config.js --mode production"));

gulp.task(
  "default",
  gulp.series("clean", "copy-files", "compile-ts", "compile-ts-umd", "compile-ts-es", "copy-parser", "nools"),
);
