...
import { base_assert } from "./assert";
import { base_dispose } from "./dispose";
import { Args, Context, FactObject, INode, INodeWithPatterns } from "./import";
import { base_modify } from "./modify";
import { base_retract } from "./retract";
...
export function propagate_smf<TObject extends FactObject>(
  fn: Args<TObject>
): Args<TObject> {
...
export function propagate_dispose(
