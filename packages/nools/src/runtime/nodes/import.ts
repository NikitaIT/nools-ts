...
export { IConstraint, is_instance_of_equality, is_instance_of_reference_constraint } from "../../constraint";
...
export { addConstraint, create_join_reference_node } from "../../nodes/join-reference-node";
